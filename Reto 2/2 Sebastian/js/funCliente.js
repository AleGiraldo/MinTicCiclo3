function consulta() {
    $.ajax({
        url:"https://g78fe6d3edb11e3-room.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"JSON",
...
function elemEspecifico(idItem){
    $.ajax({
        url:"https://g78fe6d3edb11e3-room.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client" + idItem,
        type:"GET",
        datatype:"JSON",
        success:function(response){
            console.log(response)
